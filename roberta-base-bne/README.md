...
En ningÃºn caso el propietario de los modelos (SEDIA) ni el creador (BSC) serÃ¡n responsables de los resultados derivados del uso que hagan terceros de estos models.
</details>
