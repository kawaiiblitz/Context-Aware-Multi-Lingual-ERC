...
def classify_text(text, context):
    ...
    context_text = " ".join([f"Text: {utterance['text']}" for utterance in context])
...
def main():
    ...
    parser.add_argument('--window_size', type=int, default=5, help='Size of the context window to consider.')
    args = parser.parse_args()

    test_true, test_pred = process_file(args.test_file, args.output_dir, window_size=args.window_size)
