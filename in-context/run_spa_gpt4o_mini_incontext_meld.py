...
def classify_text(text, context):
    examples = [
        ...
        "---",
        # Conversation 4
        "Text: Que asco! Que ha sido eso? Algo ha explotado!",
        "Class: disgust",
        "Text: Solo ha roto aguas. Calmate, quieres?",
        "Class: neutral",
        "Text: Romper aguas, que quieres decir? Que es eso de romper aguas?",
        "Class: surprise",
        "Text: Respira, respira, respira.",
        "Class: neutral",
        "---",
        # Conversation 5
        "Text: Por favor!",
        "Class: anger",
        "Text: Me tomas el pelo?",
        "Class: anger",
        "Text: Heri a tres hombres enormes, le hice sangrar la nariz a un tipo... no estoy orgulloso de ello, pero de verdad que lo estoy.",
        "Class: anger",
        "Text: Y todo es gracias a ti, maravilloso, increible tu.",
        "Class: joy",
        "Text: Creo que tienes conmocion cerebral.",
        "Class: fear",
        "---",
        # Conversation 6
        "Text: Que si! Quieres una pista? Eh? \"Si quiero\" \"Si quiero\".",
        "Class: joy",
        "Text: Ok, estoy sintiendo que esto es algun tipo de juego de palabras, porque eres de color rosa con alegria apenas controlada.",
        "Class: neutral",
        "Text: David va a proponerle matrimonio a Phoebe.",
        "Class: joy",
        "Text: Por que? Por que?",
        "Class: surprise",
        "---",
]    
    examples_text = "\n".join(examples)
